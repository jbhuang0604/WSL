...
enum SoftmaxPairParameter_Engine {
  SoftmaxPairParameter_Engine_DEFAULT = 0,
  SoftmaxPairParameter_Engine_CAFFE = 1,
  SoftmaxPairParameter_Engine_CUDNN = 2
};
bool SoftmaxPairParameter_Engine_IsValid(int value);
const SoftmaxPairParameter_Engine SoftmaxPairParameter_Engine_Engine_MIN = SoftmaxPairParameter_Engine_DEFAULT;
const SoftmaxPairParameter_Engine SoftmaxPairParameter_Engine_Engine_MAX = SoftmaxPairParameter_Engine_CUDNN;
const int SoftmaxPairParameter_Engine_Engine_ARRAYSIZE = SoftmaxPairParameter_Engine_Engine_MAX + 1;

const ::google::protobuf::EnumDescriptor* SoftmaxPairParameter_Engine_descriptor();
inline const ::std::string& SoftmaxPairParameter_Engine_Name(SoftmaxPairParameter_Engine value) {
  return ::google::protobuf::internal::NameOfEnum(
    SoftmaxPairParameter_Engine_descriptor(), value);
}
inline bool SoftmaxPairParameter_Engine_Parse(
    const ::std::string& name, SoftmaxPairParameter_Engine* value) {
  return ::google::protobuf::internal::ParseNamedEnum<SoftmaxPairParameter_Engine>(
    SoftmaxPairParameter_Engine_descriptor(), name, value);
}
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.SoftmaxPairParameter softmax_pair_param = 132;
  bool has_softmax_pair_param() const;
  void clear_softmax_pair_param();
  static const int kSoftmaxPairParamFieldNumber = 132;
  const ::caffe::SoftmaxPairParameter& softmax_pair_param() const;
  ::caffe::SoftmaxPairParameter* mutable_softmax_pair_param();
  ::caffe::SoftmaxPairParameter* release_softmax_pair_param();
  void set_allocated_softmax_pair_param(::caffe::SoftmaxPairParameter* softmax_pair_param);
 ...
 private:
  ...
  inline void set_has_softmax_pair_param();
  inline void clear_has_softmax_pair_param();
  ...
  ::caffe::SoftmaxPairParameter* softmax_pair_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class SoftmaxPairParameter : public ::google::protobuf::Message {
 public:
  SoftmaxPairParameter();
  virtual ~SoftmaxPairParameter();

  SoftmaxPairParameter(const SoftmaxPairParameter& from);

  inline SoftmaxPairParameter& operator=(const SoftmaxPairParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const SoftmaxPairParameter& default_instance();

  void Swap(SoftmaxPairParameter* other);

  // implements Message ----------------------------------------------

  inline SoftmaxPairParameter* New() const { return New(NULL); }

  SoftmaxPairParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const SoftmaxPairParameter& from);
  void MergeFrom(const SoftmaxPairParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(SoftmaxPairParameter* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  typedef SoftmaxPairParameter_Engine Engine;
  static const Engine DEFAULT = SoftmaxPairParameter_Engine_DEFAULT;
  static const Engine CAFFE = SoftmaxPairParameter_Engine_CAFFE;
  static const Engine CUDNN = SoftmaxPairParameter_Engine_CUDNN;
  static inline bool Engine_IsValid(int value) {
    return SoftmaxPairParameter_Engine_IsValid(value);
  }
  static const Engine Engine_MIN =
    SoftmaxPairParameter_Engine_Engine_MIN;
  static const Engine Engine_MAX =
    SoftmaxPairParameter_Engine_Engine_MAX;
  static const int Engine_ARRAYSIZE =
    SoftmaxPairParameter_Engine_Engine_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Engine_descriptor() {
    return SoftmaxPairParameter_Engine_descriptor();
  }
  static inline const ::std::string& Engine_Name(Engine value) {
    return SoftmaxPairParameter_Engine_Name(value);
  }
  static inline bool Engine_Parse(const ::std::string& name,
      Engine* value) {
    return SoftmaxPairParameter_Engine_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // optional .caffe.SoftmaxPairParameter.Engine engine = 1 [default = DEFAULT];
  bool has_engine() const;
  void clear_engine();
  static const int kEngineFieldNumber = 1;
  ::caffe::SoftmaxPairParameter_Engine engine() const;
  void set_engine(::caffe::SoftmaxPairParameter_Engine value);
  ...
  // @@protoc_insertion_point(class_scope:caffe.SoftmaxPairParameter)
 private:
  inline void set_has_engine();
  inline void clear_has_engine();
  inline void set_has_axis();
  ...
  void InitAsDefaultInstance();
  static SoftmaxPairParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.SoftmaxPairParameter softmax_pair_param = 132;
inline bool LayerParameter::has_softmax_pair_param() const {
  return (_has_bits_[1] & 0x00000800u) != 0;
}
inline void LayerParameter::set_has_softmax_pair_param() {
  _has_bits_[1] |= 0x00000800u;
}
inline void LayerParameter::clear_has_softmax_pair_param() {
  _has_bits_[1] &= ~0x00000800u;
}
inline void LayerParameter::clear_softmax_pair_param() {
  if (softmax_pair_param_ != NULL) softmax_pair_param_->::caffe::SoftmaxPairParameter::Clear();
  clear_has_softmax_pair_param();
}
inline const ::caffe::SoftmaxPairParameter& LayerParameter::softmax_pair_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.softmax_pair_param)
  return softmax_pair_param_ != NULL ? *softmax_pair_param_ : *default_instance_->softmax_pair_param_;
}
inline ::caffe::SoftmaxPairParameter* LayerParameter::mutable_softmax_pair_param() {
  set_has_softmax_pair_param();
  if (softmax_pair_param_ == NULL) {
    softmax_pair_param_ = new ::caffe::SoftmaxPairParameter;
  }
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.softmax_pair_param)
  return softmax_pair_param_;
}
inline ::caffe::SoftmaxPairParameter* LayerParameter::release_softmax_pair_param() {
  clear_has_softmax_pair_param();
  ::caffe::SoftmaxPairParameter* temp = softmax_pair_param_;
  softmax_pair_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_softmax_pair_param(::caffe::SoftmaxPairParameter* softmax_pair_param) {
  delete softmax_pair_param_;
  softmax_pair_param_ = softmax_pair_param;
  if (softmax_pair_param) {
    set_has_softmax_pair_param();
  } else {
    clear_has_softmax_pair_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.softmax_pair_param)
}
...
// optional .caffe.SoftmaxPairParameter.Engine engine = 1 [default = DEFAULT];
inline bool SoftmaxPairParameter::has_engine() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void SoftmaxPairParameter::set_has_engine() {
  _has_bits_[0] |= 0x00000001u;
}
inline void SoftmaxPairParameter::clear_has_engine() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void SoftmaxPairParameter::clear_engine() {
  engine_ = 0;
  clear_has_engine();
}
inline ::caffe::SoftmaxPairParameter_Engine SoftmaxPairParameter::engine() const {
  // @@protoc_insertion_point(field_get:caffe.SoftmaxPairParameter.engine)
  return static_cast< ::caffe::SoftmaxPairParameter_Engine >(engine_);
}
inline void SoftmaxPairParameter::set_engine(::caffe::SoftmaxPairParameter_Engine value) {
  assert(::caffe::SoftmaxPairParameter_Engine_IsValid(value));
  set_has_engine();
  engine_ = value;
  // @@protoc_insertion_point(field_set:caffe.SoftmaxPairParameter.engine)
}

// optional int32 axis = 2 [default = 1];
inline bool SoftmaxPairParameter::has_axis() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void SoftmaxPairParameter::set_has_axis() {
  _has_bits_[0] |= 0x00000002u;
}
inline void SoftmaxPairParameter::clear_has_axis() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void SoftmaxPairParameter::clear_axis() {
  axis_ = 1;
  clear_has_axis();
}
inline ::google::protobuf::int32 SoftmaxPairParameter::axis() const {
  // @@protoc_insertion_point(field_get:caffe.SoftmaxPairParameter.axis)
  return axis_;
}
inline void SoftmaxPairParameter::set_axis(::google::protobuf::int32 value) {
  set_has_axis();
  axis_ = value;
  // @@protoc_insertion_point(field_set:caffe.SoftmaxPairParameter.axis)
}
...
template <> struct is_proto_enum< ::caffe::SoftmaxPairParameter_Engine> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::SoftmaxPairParameter_Engine>() {
  return ::caffe::SoftmaxPairParameter_Engine_descriptor();
}
